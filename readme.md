...
<p align="center">
  <img src="docs/ragflow.jpg" width="1000"/>
</p>
...
| `plot_anomaly(df, date, node=None, field=None, save_dir="plot_pics", drawn_fields=None)` | Vẽ biểu đồ các KPI bất thường theo ngày, highlight điểm bất thường.             |
